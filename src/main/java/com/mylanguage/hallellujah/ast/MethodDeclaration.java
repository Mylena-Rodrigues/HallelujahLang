...
public class MethodDeclaration implements ASTNode {
    ...
    private List<String> parameterTypes; // Adicionando a lista de tipos dos parâmetros
    private List<ASTNode> body;
    private Map<String, Object> localSymbolTable;

    public MethodDeclaration(String type, String methodName, List<String> parameterTypes, List<ASTNode> body,
