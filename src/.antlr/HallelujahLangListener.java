...
public interface HallelujahLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#field_declaration}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#assignment_statement}.
	 * @param ctx the parse tree
	 */
	void enterAssignment_statement(HallelujahLangParser.Assignment_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link HallelujahLangParser#assignment_statement}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#method_call_statement}.
	 * @param ctx the parse tree
	 */
	void enterMethod_call_statement(HallelujahLangParser.Method_call_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link HallelujahLangParser#method_call_statement}.
	 * @param ctx the parse tree
	 */
	void exitMethod_call_statement(HallelujahLangParser.Method_call_statementContext ctx);
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#class_method_call}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#this_class_method_call}.
	 * @param ctx the parse tree
	 */
	void enterThis_class_method_call(HallelujahLangParser.This_class_method_callContext ctx);
	/**
	 * Exit a parse tree produced by {@link HallelujahLangParser#this_class_method_call}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link HallelujahLangParser#constructor_fields_declaration}.
	 * @param ctx the parse tree
	 */
	void enterConstructor_fields_declaration(HallelujahLangParser.Constructor_fields_declarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link HallelujahLangParser#constructor_fields_declaration}.
	 * @param ctx the parse tree
	 */
